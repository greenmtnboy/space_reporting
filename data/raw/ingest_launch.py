...
# Shape as of GCAT release 1.8.4 (2026 Jul 29): 32 columns. Perigee, Inc, Azimuth
# and OrbMass were added that release and are not populated upstream yet.
...
LAUNCH_HEADERS = [
    ...
    "Ascent_Site", "Ascent_Pad", "Perigee", "Apogee", "Apoflag", "Inc",
